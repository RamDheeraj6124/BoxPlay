...
const News = () => {
    ...
    useEffect(() => {
        ...
        fetch("https://newsdata.io/api/1/news?apikey=pub_66465d644c11d4df42868252ecc7a8089cd1d&q=sport")
            .then((response) => {
                if (!response.ok) {
        ...
        <div className="news-container">
            ...
            <div className="row">
                {articles && articles.length > 0 ? ( // Check if articles exist and has length
                    articles.filter(article => article.image_url).map((article, index) => (
